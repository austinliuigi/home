  ...
  config = lib.mkIf cfg.enable {
    ...
    home.activation = {
      wallpaper = lib.hm.dag.entryAfter ["writeBoundary"] ''
        ...
        $DRY_RUN_CMD ${pkgs.imagemagick}/bin/convert ${config.dotfiles._wallpapers}/wallpaper.png -fill \#${config.colorscheme.colors.base02} -tint 50 ~/wallpapers/wallpaper.png 2> /dev/null
