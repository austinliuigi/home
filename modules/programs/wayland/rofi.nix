...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    home.file = {
      ".local/share/rofi/themes/_palette.rasi".text = config.configuration.interpolateConfigFileWithMsg {
        file = "${config.dotfiles.rofi}/.local/share/rofi/themes/_palette.rasi";
        comment_start = "//";
      };
      ".local/share/rofi/themes/_font.rasi".text = config.configuration.interpolateConfigFileWithMsg {
        file = "${config.dotfiles.rofi}/.local/share/rofi/themes/_font.rasi";
        comment_start = "//";
      };
