...
vim.keymap.set("n", "<leader>f", "<cmd>lua require('telescope.builtin').find_files({hidden = true, follow=true})<CR>")
vim.keymap.set("n", "<C-/>", "<cmd>lua require('telescope.builtin').builtin()<CR>")
